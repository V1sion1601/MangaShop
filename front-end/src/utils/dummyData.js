...
export const updateproduct = async (id,name,price,quantity)=>{
  const url="/product/updateproduct/"+id+"/"+name+"/"+price+"/"+quantity;
  console.log(url);
  return api.put(url);
}
export const createproduct = async (name,price,quantity,image)=>{
  const url="/product/create/"+name+"/"+price+"/"+quantity+"/"+image;
  console.log(url);
  return api.put(url);
}
...
export const createsale = async (name,percent,require,date_start,date_finish)=>{
  const url ="/sale/"+name+"/"+percent+"/"+require+"/"+date_start+"/"+date_finish;
  console.log(url);
  return api.put(url);
}
export const updatesale = async (id,name,percent,require,date_start,date_finish)=>{
  const url ="/sale/update/"+id+"/"+name+"/"+percent+"/"+require+"/"+date_start+"/"+date_finish;
  console.log(url);
  return api.get(url);
}
...
export const updateprofile = async(id,name,address,phone,ID_account)=>{
  const url = "/cus/update/"+id+"/"+name+"/"+address+"/"+phone+"/"+ID_account;
  return api.post(url);
}
